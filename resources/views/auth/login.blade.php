    ...
    <div class="bg-white p-8 sm:p-10 rounded-3xl border border-slate-100 shadow-2xl w-full max-w-md relative overflow-hidden">
        ...
        <div class="mt-6 pt-5 border-t border-slate-100 text-center space-y-2">
            <p class="text-xs text-slate-500 font-medium">
                ...
                <a href="{{ route('register') }}" class="text-emerald-600 hover:text-emerald-700 font-bold underline decoration-2 underline-offset-2">Sign Up here</a>
            </p>
            <div>
                <a href="{{ route('landing') }}" class="inline-block mt-2 text-xs text-slate-400 hover:text-slate-600 font-medium">&larr; Back to Home</a>
            </div>
        </div>
    </div>
