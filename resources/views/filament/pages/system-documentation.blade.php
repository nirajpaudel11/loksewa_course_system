    ...
    <div x-data="{ activeTab: 'admin' }" class="sys-doc-wrap">
        ...
        <div class="sys-doc-tabs">
            <button 
                ...
                <x-heroicon-s-shield-check class="sys-icon-sm" />
            ...
            <button 
                ...
                class="sys-doc-tab-btn">
                <x-heroicon-s-academic-cap class="sys-icon-sm" />
        ...
        <div x-show="activeTab === 'admin'" x-transition class="sys-doc-card">
            <div class="sys-doc-header">
                ...
                <a href="{{ asset('storage/docs/Loksewa_Admin_and_Algorithms_Manual.pdf') }}" target="_blank" download class="sys-doc-download-btn">
                    <x-heroicon-m-arrow-down-tray class="sys-icon-sm" />
        ...
        <div x-show="activeTab === 'student'" x-transition class="sys-doc-card">
            <div class="sys-doc-header">
                ...
                <a href="{{ asset('storage/docs/Loksewa_Student_User_Manual.pdf') }}" target="_blank" download class="sys-doc-download-btn sys-doc-download-btn-sky">
                    <x-heroicon-m-arrow-down-tray class="sys-icon-sm" />
